    ...
    methods: {
        ...
        getTableData: function () {
            ...
            $.ajax({
                ...
                url: "" + baseURL + "sys/checkList/queryCheckListReport",
                success: function (json) {
                    console.log(json);
                    self.tableDataEnd = json.body;
        ...
        getUser() {
            $.getJSON(baseURL + "sys/user/info", function (r) {
                console.log(r.user);
                vm.ruleForm.groupId = r.user.deptId;
        ...
        getprofessionalNames() {
            $.ajax({
                ...
                success: function (json) {
                    vm.professionalNames = json.body;
                }
            });
        },
        getlevels() {
        ...
        serach() {
            ...
            let data;
            if (vm.ruleForm.getmemberId == null || vm.ruleForm.getmemberId == '' || vm.ruleForm.getmemberId == undefined) {
                data = {
        ...
        entering() {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    ...
                    "universityId": vm.compileData[0].universityName,

var vm = new Vue({
    ...
    methods: {
        ...
        getTableData: function () {
          ...
          enrolTime:1,
                    'deptId':this.groupIdH,
                },
                url: "" + baseURL + "sys/privatestudWx/selectforlistGroup",
        ...
        getUser() {
            $.getJSON(baseURL + "sys/user/info", function (r) {
                // console.log('ppppp', r);
                if(r.user.deptId == null || r.user.deptId == '' || r.user.deptId == undefined){
                    vm.groupIdH = '';
                } else {
                    vm.groupIdH = r.user.deptId;
                }
        ...
        getmembers() {
            ...
            if (vm.changeBindSchoolButton == false) {
                vm.ruleForm.groupId = vm.groupIdH
            }
            $.ajax({
                type: "get",
                dataType: "json",
